...
<html>
   ...
   %>
      <!-- heading 1 -->
      <h1 class="bold topp left" > $ SQL Injection 3</h1>
      <h2></h2>
      <!-- gray text --->
      ...
      <form action="SQL3.jsp" method="get" style="margin-left: 35%;">
...
%>
      ...
      <footer class="w3-center w3-black w3-padding-64 w3-opacity w3-hover-opacity-off">
         ...
         <p>
            ...
            <h> & </h> <a href="XSS4.jsp" title="" target="_self" class="w3-hover-text-green">NEXT &#8594</a></br>
