...
<html>
   ...
   <body>
      ...
      if(mem_id == null && mem_pw == null){
         ...
         out.println("<a href=\"../logic/Sessionlogout.jsp\" class=\"button \">Logout</a>");
      }
      %>
      <!-- horizontal rule-->
      <hr class="hr">
      ...
      <!-- link -->
      <p><a href="#" title="jekyll-hacker-theme" target="_self" class="linkk bold">Link to Jekyll Hacker Theme.</a></p>
