...
<link rel="icon" href="https://avatars.githubusercontent.com/u/69230350?v=4">
  ...
  <body>
    ...
    if(mem_id==null && mem_pw == null){
      ...
      if(SQL3==null){
      out.println("<script>alert(\"You can try after clearing Level 4.\"); location.href=\"../view/SQL4.jsp\"</script>");
      }else{
    %>
    <div class="login">
      
      <h2 class="login-header">$ Lv5. SQL Injection</h2>
      <form action="../logic/SQLaction5.jsp" class="login-container" method="post">
...
try{
    ...
    rs = stmt.executeQuery(sql);
        ...
        <p>
          ...
          <h> & </h> <a href="SQL6.jsp" title="" target="_self" class="w3-hover-text-green">NEXT &#8594</a></p></br>
